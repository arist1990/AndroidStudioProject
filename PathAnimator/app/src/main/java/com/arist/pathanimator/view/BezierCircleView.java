...
import com.arist.pathanimator.entity.HPoint;
import com.arist.pathanimator.entity.VPoint;
...
public class BezierCircleView extends View {
    ...
    private void init() {
        ...
        p1 = new HPoint();
        p3 = new HPoint();
        radius = (int)(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
        c = radius * blackMagic;
    ...
    private void movePosition() {
        float offset = (getWidth() - 3 * radius - radius / 2) * (mInterpolatedTime - 0.2f);
        offset = offset > 0 ? offset : 0;
        offset = offset + 2 * radius + radius / 2;
