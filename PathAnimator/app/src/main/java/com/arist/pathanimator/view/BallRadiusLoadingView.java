 ...
 */
public class BallRadiusLoadingView extends View {

    public BallRadiusLoadingView(Context context) {
        super(context);
    }

    public BallRadiusLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BallRadiusLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void startLoading(){
        ...
        valueAnimator = ValueAnimator.ofFloat(radiusBallMin, radiusBallMax);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                ballRadiusList.set(0, radius);
                ballRadiusList.set(1, radiusBallMin + radiusBallMax - radius);
    ...
    private void init(){
        ...
        radiusBallMax = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 7, getResources().getDisplayMetrics());
        radiusBallMin = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics());
...
//                getResources().getColor(R.color.colorAccent), getResources().getColor(R.color.colorPrimary), Shader.TileMode.CLAMP));
        ...
        ballRadiusList.add(radiusBallMax);
        ballColorList.add(getResources().getColor(R.color.colorAccent));
        ballColorList.add(getResources().getColor(R.color.colorPrimary));
