 ...
 */
public class PageControlLineAnimated extends View {
...
//                    float progress = (float) animation.getAnimatedFraction();
    ...
    public PageControlLineAnimated(Context context) {
        super(context);

        initAttr(context, null);
    }

    public PageControlLineAnimated(Context context, AttributeSet attrs) {
        super(context, attrs);

        initAttr(context, attrs);
    }

    public PageControlLineAnimated(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnSwitchChangeListener {
        public void onChange(PageControlLineAnimated view, int index);
    }
